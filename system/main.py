...
if __name__ == "__main__":
    ...
    parser.add_argument('-jr', "--join_ratio", type=float, default=0.1, help="每轮参与训练的客户端比例")
    parser.add_argument('-rjr', "--random_join_ratio", type=bool, default=False, help="每轮随机选择客户端比例")
    parser.add_argument('-nc', "--num_clients", type=int, default=100, help="客户端总数")
    ...
    parser.add_argument("--public_feature_key", type=str, default="x", help="公共测试集特征列名")
    parser.add_argument("--public_label_key", type=str, default="y", help="公共测试集标签列名")
    # 实际部署相关参数
